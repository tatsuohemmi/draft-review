...
source: "[[DRAGONADE]]"
enccre_url: "https://enccre.academie-sciences.fr/encyclopedie/article/v5-149-0/"
tags:
  - project/reel6
  - draft
...
「竜騎兵による強制改宗」（dragonnade）に関する百科全書項目。ディドロ執筆。ルイ14世のプロテスタント迫害政策を批判する一連の項目の一つである。 ^p0003

本項目は竜騎兵による強制改宗を主題とし、ナント勅令廃止およびプロテスタント迫害の文脈のなかに位置づけられている。

## 書誌

- ENCCRE: https://enccre.academie-sciences.fr/encyclopedie/article/v5-149-0/
